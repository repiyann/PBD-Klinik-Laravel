            ...
            <div class="flex justify-between border-b md:border-none pb-3 md:p-0">
                ...
                <div @click="showMenu = true" class="md:hidden">
                    <button class="group" aria-expanded="false">
                        <svg class="absolute block transition duration-150" :class="showMenu && 'rotate-45 opacity-0'" xmlns="http://www.w3.org/2000/svg" height="24" width="21" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
